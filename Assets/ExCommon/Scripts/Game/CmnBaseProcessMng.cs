...
public class CmnBaseProcessMng : MonoBehaviour
{
    ...
    private static bool InitLoading {
        get; set;
    }
    ...
    public static ConfirmWindowCmn showConfirmVoid(string txt, System.Action callback, bool isHold = false) {
        return showConfirm(txt, (object obj) => {
            callback();
        }, null, isHold);
    }
    ...
    public static ConfirmWindowCmn showConfirmVoid(string txt, System.Action callback, System.Action cansel, bool isHold = false) {
        return showConfirm(txt,
            (object obj) => { callback(); },
            (object obj) => { cansel(); },
            null, isHold);
    }
